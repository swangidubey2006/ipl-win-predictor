...
We have added a high-end, premium web interface with a **Black and Blue** cinematic theme, glassmorphic design, and smooth animations.

### Running the Premium Version Locally
...
- **Cinematic Black & Blue Aesthetic**: Dark-mode optimized for a premium feel.
- **Glassmorphic UI**: Modern translucent cards with smooth blurs.
- **Micro-Animations**: Real-time probability bar animations and smooth transitions.
